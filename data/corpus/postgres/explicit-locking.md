...
| --- | --- | --- | --- | --- |
| [Prev](transaction-iso.html "13.2. Transaction Isolation") | [Up](mvcc.html "Chapter 13. Concurrency Control") | Chapter 13. Concurrency Control | [Home](index.html "PostgreSQL 17.10 Documentation") | [Next](applevel-consistency.html "13.4. Data Consistency Checks at the Application Level") |
...
To examine a list of the currently outstanding locks in a database server, use the [`pg_locks`](view-pg-locks.html "52.12. pg_locks") system view. For more information on monitoring the status of the lock manager subsystem, refer to [Chapter 27](monitoring.html "Chapter 27. Monitoring Database Activity").
...
Like all locks in PostgreSQL, a complete list of advisory locks currently held by any session can be found in the [`pg_locks`](view-pg-locks.html "52.12. pg_locks") system view.
...
The functions provided to manipulate advisory locks are described in [Section 9.28.10](functions-admin.html#FUNCTIONS-ADVISORY-LOCKS "9.28.10. Advisory Lock Functions").
...
| 13.2. Transaction Isolation | [Home](index.html "PostgreSQL 17.10 Documentation") | 13.4. Data Consistency Checks at the Application Level |
