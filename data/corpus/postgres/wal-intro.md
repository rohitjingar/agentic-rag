...
| --- | --- | --- | --- | --- |
| [Prev](checksums.html "28.2. Data Checksums") | [Up](wal.html "Chapter 28. Reliability and the Write-Ahead Log") | Chapter 28. Reliability and the Write-Ahead Log | [Home](index.html "PostgreSQL 17.10 Documentation") | [Next](wal-async-commit.html "28.4. Asynchronous Commit") |
...
WAL also makes it possible to support on-line backup and point-in-time recovery, as described in [Section 25.3](continuous-archiving.html "25.3. Continuous Archiving and Point-in-Time Recovery (PITR)"). By archiving the WAL data we can support reverting to any time instant covered by the available WAL data: we simply install a prior physical backup of the database, and replay the WAL just as far as the desired time. What's more, the physical backup doesn't have to be an instantaneous snapshot of the database state — if it is made over some period of time, then replaying the WAL for that period will fix any internal inconsistencies.

---

|  |  |  |
| --- | --- | --- |
| [Prev](checksums.html "28.2. Data Checksums") | [Up](wal.html "Chapter 28. Reliability and the Write-Ahead Log") | [Next](wal-async-commit.html "28.4. Asynchronous Commit") |
| 28.2. Data Checksums | [Home](index.html "PostgreSQL 17.10 Documentation") | 28.4. Asynchronous Commit |
