| 11.2. Index Types | | | | |
| --- | --- | --- | --- | --- |
| [Prev](indexes-intro.html "11.1. Introduction") | [Up](indexes.html "Chapter 11. Indexes") | Chapter 11. Indexes | [Home](index.html "PostgreSQL 17.10 Documentation") | [Next](indexes-multicolumn.html "11.3. Multicolumn Indexes") |
...
(See [Section 9.11](functions-geometry.html "9.11. Geometric Functions and Operators") for the meaning of these operators.) The GiST operator classes included in the standard distribution are documented in [Table 64.1](gist.html#GIST-BUILTIN-OPCLASSES-TABLE "Table 64.1. Built-in GiST Operator Classes"). Many other GiST operator classes are available in the `contrib` collection or as separate projects. For more information see [Section 64.2](gist.html "64.2. GiST Indexes").
...
which finds the ten places closest to a given target point. The ability to do this is again dependent on the particular operator class being used. In [Table 64.1](gist.html#GIST-BUILTIN-OPCLASSES-TABLE "Table 64.1. Built-in GiST Operator Classes"), operators that can be used in this way are listed in the column “Ordering Operators”.
...
(See [Section 9.11](functions-geometry.html "9.11. Geometric Functions and Operators") for the meaning of these operators.) The SP-GiST operator classes included in the standard distribution are documented in [Table 64.2](spgist.html#SPGIST-BUILTIN-OPCLASSES-TABLE "Table 64.2. Built-in SP-GiST Operator Classes"). For more information see [Section 64.3](spgist.html "64.3. SP-GiST Indexes").

Like GiST, SP-GiST supports “nearest-neighbor” searches. For SP-GiST operator classes that support distance ordering, the corresponding operator is listed in the “Ordering Operators” column in [Table 64.2](spgist.html#SPGIST-BUILTIN-OPCLASSES-TABLE "Table 64.2. Built-in SP-GiST Operator Classes").
...
(See [Section 9.19](functions-array.html "9.19. Array Functions and Operators") for the meaning of these operators.) The GIN operator classes included in the standard distribution are documented in [Table 64.3](gin.html#GIN-BUILTIN-OPCLASSES-TABLE "Table 64.3. Built-in GIN Operator Classes"). Many other GIN operator classes are available in the `contrib` collection or as separate projects. For more information see [Section 64.4](gin.html "64.4. GIN Indexes").
...
The BRIN operator classes included in the standard distribution are documented in [Table 64.4](brin.html#BRIN-BUILTIN-OPCLASSES-TABLE "Table 64.4. Built-in BRIN Operator Classes"). For more information see [Section 64.5](brin.html "64.5. BRIN Indexes").
...
| 11.1. Introduction | [Home](index.html "PostgreSQL 17.10 Documentation") | 11.3. Multicolumn Indexes |
