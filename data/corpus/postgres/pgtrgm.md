| F.33. pg\_trgm — support for similarity of text using trigram matching | | | | |
| --- | --- | --- | --- | --- |
| [Prev](pgsurgery.html "F.32. pg_surgery — perform low-level surgery on relation data") | [Up](contrib.html "Appendix F. Additional Supplied Modules and Extensions") | Appendix F. Additional Supplied Modules and Extensions | [Home](index.html "PostgreSQL 17.10 Documentation") | [Next](pgvisibility.html "F.34. pg_visibility — visibility map information and utilities") |

---

## F.33. pg\_trgm — support for similarity of text using trigram matching [#](#PGTRGM)

[F.33.1. Trigram (or Trigraph) Concepts](pgtrgm.html#PGTRGM-CONCEPTS)

[F.33.2. Functions and Operators](pgtrgm.html#PGTRGM-FUNCS-OPS)

[F.33.3. GUC Parameters](pgtrgm.html#PGTRGM-GUC)

[F.33.4. Index Support](pgtrgm.html#PGTRGM-INDEX)

[F.33.5. Text Search Integration](pgtrgm.html#PGTRGM-TEXT-SEARCH)

[F.33.6. References](pgtrgm.html#PGTRGM-REFERENCES)

[F.33.7. Authors](pgtrgm.html#PGTRGM-AUTHORS)

The `pg_trgm` module provides functions and operators for determining the similarity of alphanumeric text based on trigram matching, as well as index operator classes that support fast searching for similar strings.

This module is considered “trusted”, that is, it can be installed by non-superusers who have `CREATE` privilege on the current database.

### F.33.1. Trigram (or Trigraph) Concepts [#](#PGTRGM-CONCEPTS)
...
### F.33.2. Functions and Operators [#](#PGTRGM-FUNCS-OPS)

The functions provided by the `pg_trgm` module are shown in [Table F.25](pgtrgm.html#PGTRGM-FUNC-TABLE "Table F.25. pg_trgm Functions"), the operators in [Table F.26](pgtrgm.html#PGTRGM-OP-TABLE "Table F.26. pg_trgm Operators").
...
### F.33.3. GUC Parameters [#](#PGTRGM-GUC)
...
### F.33.4. Index Support [#](#PGTRGM-INDEX)
...
### F.33.5. Text Search Integration [#](#PGTRGM-TEXT-SEARCH)
...
### F.33.6. References [#](#PGTRGM-REFERENCES)
...
|  |  |  |
| --- | --- | --- |
| [Prev](pgsurgery.html "F.32. pg_surgery — perform low-level surgery on relation data") | [Up](contrib.html "Appendix F. Additional Supplied Modules and Extensions") | [Next](pgvisibility.html "F.34. pg_visibility — visibility map information and utilities") |
| F.32. pg\_surgery — perform low-level surgery on relation data | [Home](index.html "PostgreSQL 17.10 Documentation") | F.34. pg\_visibility — visibility map information and utilities |
