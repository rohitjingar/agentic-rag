...
### 50.5.1. Generating Possible Plans [#](#PLANNER-OPTIMIZER-GENERATING-POSSIBLE-PLANS)
...
When `geqo_threshold` is exceeded, the join sequences considered are determined by heuristics, as described in [Chapter 60](geqo.html "Chapter 60. Genetic Query Optimizer"). Otherwise the process is the same.
...
|  |  |  |
| --- | --- | --- |
| [Prev](rule-system.html "50.4. The PostgreSQL Rule System") | [Up](overview.html "Chapter 50. Overview of PostgreSQL Internals") | [Next](executor.html "50.6. Executor") |
| 50.4. The PostgreSQL Rule System | [Home](index.html "PostgreSQL 17.10 Documentation") | 50.6. Executor |
